...
<div class="text-center justify-start items-start">
    ...
    <form action="" method="POST" class="">
        @csrf
        <div class="m-4">
            <div class="m-2"><label for="title" class="font-bold">Hakkımızda</label></div>
            <textarea name="title" id="title" required class="rounded-md bg-black border-2 border-yellow-400 outline-none " cols="100" rows="15">{{$home->hakkimizda}}</textarea>
        </div>
        <div class="m-4">
