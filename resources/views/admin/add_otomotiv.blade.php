...
<div class="text-center justify-start items-start">
    ...
    <form action="" method="POST" class="" enctype="multipart/form-data">
        ...
        <div class="m-4">
            <div class="m-2"><label for="brand" class="font-bold">Marka</label></div>
            <input type="text" name="brand" id="brand" required class="rounded-md bg-black border-2 border-yellow-400 outline-none">
        </div>
        <div class="m-4">
            <div class="m-2"><label for="model" class="font-bold">Model</label></div>
            <input type="text" name="model" id="model" required class="rounded-md bg-black border-2 border-yellow-400 outline-none">
        </div>
        <div class="m-4">
