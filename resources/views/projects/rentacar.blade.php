...
<main>
    <div class="">
        <div class="w-full text-center text-2xl md:text-4xl font-bold mt-16"><h2>RENT A CAR</h2></div>
            ...
            @foreach($adverts as $advert)
                <div class="grid md:grid-cols-1 p-4" id="card">
                    <div class="relative inline-block">
                        <a href="{{route("ilan")}}/rentacar/{{$advert->id}}" class="flex text-black hover:text-white ease-in-out duration-700">
